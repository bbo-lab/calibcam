...
def obj_fcn(rvecs_cams, tvecs_cams, cam_matrices, xis, ks, rvecs_boards, tvecs_boards, board_coords_3d_0, corners, projection_model="perspective"):
    ...
    if projection_model == "fisheye_equidistant":
        boards_coords = camfuncs_ag.to_ideal_plane_fisheye_equidistant(boards_coords)
    elif projection_model == "perspective":
